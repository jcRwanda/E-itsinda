...
Route::namespace('Api')->name('api.')->group(function () {
    ...
    // USSD Contribution Endpoints
    Route::controller('UssdContributionController')->prefix('ussd')->group(function () {
        Route::post('contribution', 'storeContribution');
        Route::post('contributions/get', 'getContributions');
    });
