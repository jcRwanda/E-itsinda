    ...
    <section class="account">
        <div class="account__left flex-align bg-img" data-background-image="<?php echo e(asset($activeTemplateTrue . 'images/thumbs/account-bg.png')); ?>">
            <div class="account__thumb">
                <img src="<?php echo e(getImage('assets/images/frontend/signup_bg/' . @$signupBg->data_values->image, '1920x1280')); ?>" alt="<?php echo app('translator')->get('image'); ?>">
            </div>
        </div>
        <div class="d-flex flex-wrap account__right flex-align  <?php if(!gs('registration')): ?> form-disabled <?php endif; ?>">
            ...
            <div class="account__form">
                ...
                <?php if(!gs('registration')): ?>
                    <span class="form-disabled-text">
                        ...
                        <br>
                        <br>
                        <?php echo app('translator')->get('Registration is currently disabled'); ?>
                    </span>
                <?php endif; ?>

                <div class="account-form pt-0 pb-0">
                    <a class="site-logo" href="<?php echo e(route('home')); ?>"><img src="<?php echo e(siteLogo('dark')); ?>" alt="<?php echo app('translator')->get('logo'); ?>"></a>
                    <div class="section-heading style-left">
                        <h6 class="section-heading__subtitle"><?php echo e(__(@$signupBg->data_values->heading)); ?></h6>
                        <h3 class="section-heading__title">
                            <?php echo e(__(@$signupBg->data_values->subheading)); ?>
                    ...
                    <form action="<?php echo e(route('user.register')); ?>" method="POST" class="verify-gcaptcha">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <?php if(session()->get('reference') != null && gs()->modules->referral_system): ?>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="referenceBy" class="form-label"><?php echo app('translator')->get('Referred by'); ?></label>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" id="email" class="form--control checkUser" value="<?php echo e(old('email')); ?>" required>
                                </div>
                            </div>

                            <div class="col-sm-6 col-xsm-6">
                                <div class="form-group">
                                    <label for="yourPassword" class="form-label"><?php echo app('translator')->get('Password'); ?></label>
                                    <input name="password" id="yourPassword" type="password" class="form--control <?php if(gs()->secure_password): ?> secure-password <?php endif; ?>" required>
                                </div>
                            </div>

                            <div class="col-sm-6 col-xsm-6">
                                <div class="form-group">
                                    <label for="confirmPassword" class="form-label"><?php echo app('translator')->get('Confirm password'); ?></label>
                                ...
                                <div class="col-12">
                                    <div class="form-group d-flex">
                                        <div class="form--check">
                                            <input class="form-check-input" type="checkbox" name="agree" <?php if(old('agree')): echo 'checked'; endif; ?> id="remember">
                                        </div>
                                        <div class="terms px-2">
                                            <label class="form-check-label" for="remember"><?php echo app('translator')->get('I agree with'); ?></label>
                                            <?php $__currentLoopData = $policyPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $policy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a class="text--base footer-menu__link" href="<?php echo e(route('policy.pages', $policy->slug)); ?>" target="_blank"><?php echo e(__($policy->data_values->title)); ?></a>
                                                <?php if(!$loop->last): ?>
                                                    ,
                                                <?php endif; ?>
                            ...
                            <div class="col-12">
                                <div class="have-account text-center">
                                    <p class="have-account__text"><?php echo app('translator')->get('Already Have An Account?'); ?>
                                        <a href="<?php echo e(route('user.login')); ?>" class="have-account__link text--base"><?php echo app('translator')->get('Login'); ?></a>
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h6 class="text-center mb-0"><?php echo app('translator')->get('You already have an account, please Login.'); ?></h6>
                </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/garatech.rw/itsinda/core/resources/views/templates/crystal_sky/user/auth/register.blade.php ENDPATH**/ ?>