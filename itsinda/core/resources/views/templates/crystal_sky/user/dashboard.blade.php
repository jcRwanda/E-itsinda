...
{{-- DEBUG: Amount={{@$widget['ussd_amount']}} Completed={{@$widget['ussd_contributions']}} Pending={{@$widget['ussd_pending']}} PendingAmt={{@$widget['ussd_pending_amount']}} Time={{date('H:i:s')}} --}}
<!-- WIDGET DEBUG: ussd_amount={{ @$widget['ussd_amount'] }} | ussd_contributions={{ @$widget['ussd_contributions'] }} | ussd_pending={{ @$widget['ussd_pending'] }} | ussd_pending_amount={{ @$widget['ussd_pending_amount'] }} | Time={{ now() }} -->
        <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-xsm-6">
            <div class="dashboard-widget">
                <div class="dashboard-widget__content flex-align">
                    <span class="dashboard-widget__icon flex-center">
