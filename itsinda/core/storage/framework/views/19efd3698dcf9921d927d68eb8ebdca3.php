...
<head>
    ...
    <title><?php echo e(gs()->siteName($pageTitle ?? '404 | page not found')); ?></title>
...
<body>
    <!-- error-404 start -->
    <div class="error" style="background-image: url(<?php echo e(asset('assets/errors/images/bg-404.png')); ?>)">
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-7 text-center">
                    <img src="<?php echo e(asset('assets/errors/images/error-404.png')); ?>" alt="image">
                    <span class="star-glow glow-1" style="background: url(<?php echo e(asset('assets/errors/images/star-glow.png')); ?>) no-repeat center"></span>
                    <span class="star-glow glow-2" style="background: url(<?php echo e(asset('assets/errors/images/star-glow.png')); ?>) no-repeat center"></span>
                    <span class="star-glow glow-3" style="background: url(<?php echo e(asset('assets/errors/images/star-glow.png')); ?>) no-repeat center"></span>
                    <span class="star-glow glow-4" style="background: url(<?php echo e(asset('assets/errors/images/star-glow.png')); ?>) no-repeat center"></span>
                    <h2 class="title"> <?php echo app('translator')->get('Page not found'); ?></h2>
                    <p class="description"><?php echo app('translator')->get('page you are looking for doesn\'t exist or an other error ocurred'); ?> <br> <?php echo app('translator')->get('or temporarily unavailable.'); ?></p>
                    <a href="<?php echo e(route('home')); ?>" class="cmn-btn mt-4"><span class="icon">
                        ...
                        </span><span class="text"> <?php echo app('translator')->get('Go to Home'); ?></span></a>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH /home/garatech.rw/itsinda/core/resources/views/errors/404.blade.php ENDPATH**/ ?>