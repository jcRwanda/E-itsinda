<input name="date" type="search" <?php echo e($attributes->merge(['class'=> 'form-control bg--white pe-2 date-range' ])); ?> placeholder="<?php echo app('translator')->get('Start Date - End Date'); ?>" autocomplete="off" value="<?php echo e(request()->date); ?>">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/garatech.rw/itsinda/core/resources/views/components/date-picker.blade.php ENDPATH**/ ?>